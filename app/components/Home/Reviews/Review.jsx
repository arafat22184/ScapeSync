...
export default function Review({ review }) {
  ...
  return (
    <div className="p-7 shadow-xl rounded-[22px]">
      {/* Reviewer */}
      <div className="flex items-center gap-3.5 mb-6.5">
        <Image src={image} height={48} width={48} alt={`${name} image`}></Image>
        <div>
      ...
      <div className="relative">
        <Image
          ...
          height={52}
          alt="Quote"
          className="absolute z-0 -left-3 -top-5"
        ></Image>
        <p className="text-[#637381] relative z-10 max-w-[331px]">{message}</p>
      </div>
    </div>
  );
}
